...
export default function TransporterDashboard() {
      ...
      <div className="flex items-center justify-center min-h-screen bg-green-50">
        <div className="bg-white p-6 rounded-lg shadow-md border border-green-200">
          <p className="text-green-800 text-center">
            Please connect your wallet to access the Transporter Dashboard.
          </p>
        </div>
      </div>
    );
  ...
  // If user is not Transporter
  if (userDetails?.role !== Role.Transporter) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-green-50">
        <div className="bg-white p-6 rounded-lg shadow-md border border-green-200">
          <p className="text-green-800 text-center">Only Transporter can access this dashboard.</p>
        </div>
      </div>
    );
  }
