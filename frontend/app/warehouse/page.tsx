...
export default function WarehouseDashboard() {
      ...
      <div className="flex items-center justify-center min-h-screen bg-green-50">
        <div className="bg-white p-6 rounded-lg shadow-md border border-green-200">
          <p className="text-green-800 text-center">
            Please connect your wallet to access the Warehouse Dashboard.
          </p>
        </div>
      </div>
    );
  ...
  // If user is not Warehouse
  if (userDetails?.role !== Role.Warehouse) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-green-50">
        <div className="bg-white p-6 rounded-lg shadow-md border border-green-200">
          <p className="text-green-800 text-center">Only Warehouse can access this dashboard.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="container mx-auto p-6 bg-white min-h-screen">
      ...
      <Toaster />
      <h1 className="text-3xl font-bold mb-6 text-green-800">Warehouse Dashboard</h1>
